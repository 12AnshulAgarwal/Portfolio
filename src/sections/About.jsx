...
const About = () => {
  const handleEmailClick = () => {
    window.location.href = 'mailto:anshulag.cse@gmail.com';
  };
      ...
      <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
        <div className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            ...
            <div>
              <p className="grid-headtext">Hi, I’m Anshul Agarwal</p>
            ...
            <div>
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  link.href = '/Anshul_Final.pdf';  // File must be in 'public/' folder
                  link.download = 'Anshul_Final.pdf'; // Suggested file name
